          ...
          <div className="text-center sm:text-left">
            <div className="mb-6">
              <span className="text-gray-500 font-light tracking-wide">
                Hostiva<span className="text-purple-400">*</span>
              </span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-gray-400 mb-12 max-w-lg font-light">
              Whether you&apos;re hosting or attending, Hostiva makes every event
              memorable. Join our community today.
            </p>

            <Link href="/explore">
              <Button size="xl" className={"rounded-full px-8 py-3 bg-gray-200 text-gray-800 hover:bg-gray-300 transition-all duration-200 shadow-sm"}>
                Get Started
              </Button>
            </Link>
          </div>
